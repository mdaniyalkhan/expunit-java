...
public class TypeUtility {
    ...
    public static Map<Class, Object> USER_DEFINE_TYPES_VALUE = new HashMap<>();
    ...
    public static Object createInstance(Class type) {
        return createInstance(type, 1, new HashMap<>());
    }
    ...
    public static Object createInstance(Class type, int levelInitializeUninitializedMembers) {
        return createInstance(type, levelInitializeUninitializedMembers, new HashMap<>());
    }
    ...
    private static GregorianCalendar getDate(int fieldIndex) {
        return new GregorianCalendar(Math.min(Year.MAX_VALUE, 2000 + fieldIndex), Math.min(12, 1 + fieldIndex), Math
                .min(27, 1 + fieldIndex));
    }
